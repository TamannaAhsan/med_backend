...
public class AuthController extends BaseController {
    ...
    public ResponseEntity<ApiResponse<String>> createPatient(
            @RequestBody CreatePatientRequest request,
            @RequestParam Long creatorId
    ) {

        authService.createPatient(request, creatorId);

        return success(null, "Patient created successfully", HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<ApiResponse<PatientProfile>> updatePatient(
            ...
            @RequestParam Long updaterUserId
    ) {

        PatientProfile updated = authService.updatePatientProfile(id, request, updaterUserId);
